  ...
  return (
    <div class="text-center">
      <header class="bg-base h-screen flex flex-col items-center justify-center">
        <img onClick={() => setLogInProptIsOpen(true)} src="https://upload.wikimedia.org/wikipedia/commons/8/82/Telegram_logo.svg" class="animate-pulse animate-infinite h-64 cursor-pointer" alt="logo" />
